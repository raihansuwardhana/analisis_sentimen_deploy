...
# Tokenizing dan case folding pada teks
dataset = [(word_tokenize(tweet.lower()), sentiment) for tweet, sentiment in dataset]

# Mengacak urutan dataset
import random
random.shuffle(dataset)

# Mengambil daftar berisi semua kata dari seluruh tweet setelah tokenizing dan case folding
all_words = [word for tweet, _ in dataset for word in tweet]
...
featuresets = [(extract_features(tweet), sentiment) for tweet, sentiment in dataset]
